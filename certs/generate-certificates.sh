...
echo
echo 'openssl x509 -req -extfile <(printf "subjectAltName=DNS.1:localhost,IP.1:192.168.1.101") -days 365 -in server.csr -CA ca.crt -CAkey ca.key -CAcreateserial -sha512 -out server.crt'
echo
echo "Test using:"
echo
